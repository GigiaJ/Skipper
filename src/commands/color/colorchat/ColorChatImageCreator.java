...
public class ColorChatImageCreator {
    ...
    public static void textToImage(String text, String fontStyle, Integer fontSize, Color color) throws Exception {
        ...
        ColorChatImageCreator.WrappedFormattedStrings formattedStrings = createFormatting(text, fm, fontSize, 400);
    ...
    public static ColorChatImageCreator.WrappedFormattedStrings createFormatting(String text, FontMetrics fm, Integer fontSize, int imageWidth) {
        ...
        ColorChatImageCreator.WrappedFormattedStrings formattedStrings = new ColorChatImageCreator.WrappedFormattedStrings(listOfFormattedText, list);
