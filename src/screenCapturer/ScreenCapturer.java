...
public class ScreenCapturer extends JFrame {
    ...
    private ScreenCapturer.ExamplePanel selectionPane;
    ...
    public ScreenCapturer() {
        ...
        keyboardHook.addKeyListener(new GlobalKeyAdapter() {
            ...
            public void keyReleased(GlobalKeyEvent e) {
                ...
                if (ScreenCapturer.this.isFrameVisible()) {
                    ImageInformation imageInfo;
                    Robot robot;
                    CopyToClipBoard ctx;
                    if (e.getVirtualKeyCode() == 67) {
                        imageInfo = new ImageInformation(ScreenCapturer.ExamplePanel.sx, ScreenCapturer.ExamplePanel.sy, ScreenCapturer.ExamplePanel.ex, ScreenCapturer.ExamplePanel.ey);
    ...
    private void populate() {
        this.selectionPane = new ScreenCapturer.ExamplePanel();
    ...
    public String retrieveText(File temporaryFile) throws IOException {
        ...
        api.Init(Main.baseFolder.getAbsolutePath(), "eng");
    ...
    private static void setDPI(IIOMetadata metadata) throws IIOInvalidTreeException {
        ...
        double DPI = 300.0D;
        double dotsPerMilli = 11.811023622047244D;
        ...
        public ExamplePanel() {
            MouseAdapter mouseAdapter = new MouseAdapter() {
                public void mousePressed(MouseEvent e) {
                    ScreenCapturer.ExamplePanel.ey = -1;
                    ScreenCapturer.ExamplePanel.ex = -1;
                    ScreenCapturer.ExamplePanel.sy = -1;
                    ScreenCapturer.ExamplePanel.sx = -1;
                    ScreenCapturer.ExamplePanel.sx = e.getX();
                    ScreenCapturer.ExamplePanel.sy = e.getY();
                    ExamplePanel.this.repaint();
                }

                public void mouseReleased(MouseEvent e) {
                    ScreenCapturer.ExamplePanel.ex = e.getX();
                    ScreenCapturer.ExamplePanel.ey = e.getY();
                    ExamplePanel.this.repaint();
                }
